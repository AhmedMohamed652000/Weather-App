...
//cairo is defualt city
if (inputSearch.value == '') {
  async function getWeather() {
    var apiResponse = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=c409c9f4946e44a3b02101724222711&q=cairo&days=3`)
...
inputSearch.addEventListener('keyup', function () {
  async function getWeather() {
    var apiResponse = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=c409c9f4946e44a3b02101724222711&q=${inputSearch.value}&days=3`)
    var finalResult = await apiResponse.json();
    allItems = finalResult;
    displayWeather()
  }
